...
重复性验证曾形成 [D0-06 授权包](t0-01-s1-v02-repeat-authorization.md) 并获 PO 批准，但操作人在 R02 运行前报告页面已经刷新，触发静态页面熔断条件，R02/R03 均未执行。当前 [D0-07 授权包](t0-01-s1-post-refresh-authorization.md) 已获 QSR PASS，申请一次刷新后前瞻性只读观察；PO 批准前不得运行。
