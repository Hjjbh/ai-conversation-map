...
- 启动日期：2026-09-06
- 产品授权：PO 已授权启动阶段 0
- 当前执行范围：文档、公开资料核对，以及专用非敏感测试会话的只读探针与脱敏 fixture；D0-09B 另批准 T0-03 的一次受限滚动和临时 overlay 可见副作用，但尚未运行
...
| T0-03 | 双向定位技术验证 | ADP + UIE | GDE + QSR | D0-09A 实现完成；D0-09B 已创建并获 PO 批准；真实环境未运行 |
...
- `d0-09b-s1-locate-run-authorization.md`：D0-09B 最终版本绑定、R01/R02 动作边界、清理 watchdog、失效规则与 PO 批准记录（已批准，尚未运行）。
- `tools/stage-0/chatgpt-locate-summary-probe.js`：D0-09A T0-03 临时定位摘要探针（0.1.0，已获 D0-09B 限定授权；R01 尚未运行，R02 为条件额度）。
